...
:::dna
Practice multiple sequence alignments with another set of HIV-1 sequences and the related simian immunodeficiency virus (SIV), which infects non-human primates. In this case all the SIV sequences were isolated from chimpanzees. These sequences are also from the pol gene. They are from this paper: https://pmc.ncbi.nlm.nih.gov/articles/PMC2669881/#s4.
...
Create MAFFT MSAs both in Jalview and on the server with the sequences above. Answer the following questions.
