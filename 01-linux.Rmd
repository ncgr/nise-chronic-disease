...
+ Scroll up when in a screen

You need to go into "copy mode".

```{bash, eval=FALSE}
CTRL-A + ESC
```

Now you should be able to use the arrows to scroll through the screen.

To get out of copy mode and come back to the command line, hit "ESC".
